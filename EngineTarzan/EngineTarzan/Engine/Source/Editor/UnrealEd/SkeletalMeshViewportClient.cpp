    ...
    : FEditorViewportClient()
{
    ...
    Flags OnlyPrimsAndShadow = static_cast<Flags>(Flags(EEngineShowFlags::SF_Primitives) | Flags(EEngineShowFlags::SF_Shadow) | Flags(EEngineShowFlags::SF_SkeletalMesh));
